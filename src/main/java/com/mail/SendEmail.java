...
public class SendEmail {
    ...
    public static void main(String[] args) throws Exception {
        ...
        final String username = "a0975790176@gmail.com";
        final String password = "ruefklnzcmotligo"; // 授權碼, 不是 email 的密碼
        final String to = "a0975790176@gmail.com, jack22244@yahoo.com.tw";
        // smpt 設定資訊
